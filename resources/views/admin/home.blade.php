...
@section('title','Panel d\'administration du site')
    ...
    <div class="container">
        ...
        <div class="d-flex align-items-center gap-3 flex-wrap flex-column flex-md-row mt-4 p-2">
         ...
         {{--   <div>
            ...
            <div>
                <a href="/admin/newsletter/" class="btn p-0 m-0">
                    <div
                        class="card menu_tuile d-flex justify-content-center text-white flex-column align-items-center">
                        ...
                        <h5 class="">Gestion des contacts</h5>
                    </div>
                </a>
            </div>
            @auth()
                @if( auth()->user()['role_id'] == 3|| auth()->user()['role_id'] == 4)
                    <div>
                        ...
                        <a href="/admin/users/" class="btn p-0 m-0">
